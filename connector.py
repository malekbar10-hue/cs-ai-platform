...
class JSONConnector(BaseConnector):
    ...
    def __init__(self, config):
        self.orders_file   = config["erp"].get("orders_file",   "orders.json")
        self.logs_file     = config["crm"].get("logs_file",     "logs.json")
        self.profiles_file = config["crm"].get("profiles_file", "customer_profiles.json")
